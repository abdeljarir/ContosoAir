...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield getNode(versionSpec, checkLatest);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!toolPath) {
            ...
            if (!toolPath) {
                ...
                toolPath = yield acquireNode(version, installedArch);
            }
        }
        //
...
function acquireNode(version, installedArch) {
    return __awaiter(this, void 0, void 0, function* () {
        //
        // Download - a tool installer intimately knows how to get the tool (and construct urls)
        //
        version = toolLib.cleanVersion(version);
        let fileName = osPlat == 'win32' ? 'node-v' + version + '-win-' + installedArch :
...
function acquireNodeFromFallbackLocation(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield toolLib.downloadTool(exeUrl, path.join(tempDir, "node.exe"));
            yield toolLib.downloadTool(libUrl, path.join(tempDir, "node.lib"));
        }
        catch (err) {
            if (err['httpStatusCode'] &&
                err['httpStatusCode'] == 404) {
